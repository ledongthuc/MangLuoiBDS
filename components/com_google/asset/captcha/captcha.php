...
class CaptchaSecurityImages {
	...
	function CaptchaSecurityImages($width='80',$height='30',$characters='6') {
		...
		$background_color = imagecolorallocate($image, 8, 41, 96);
...
$captcha = new CaptchaSecurityImages($width,$height,'5');
