<li>
	<span class='tinhthanh'> </span> 
	<span class='clear'> <?php echo $tinh_thanh_tk;?></span>
</li>
<li>
	<span class='quanhuyen'> </span> 
	<span class='clear'	id="quan_huyen_search"> <?php echo $quan_huyen_ycbds;?> </span>
</li>
<link
	rel="stylesheet"
	href="<?php echo JURI::root()?>modules/mod_taoyeucau/tmpl/css/jquery-ui.css"
	type="text/css" media="screen" />
<link
	rel="stylesheet"
	href="<?php echo JURI::root()?>modules/mod_taoyeucau/tmpl/css/jquery.multiselect.css"
	type="text/css" media="screen" />
<script
	type="text/javascript"
	src="<?php echo JURI::root()?>templates/mlbds/js/jquery-1.4.4.js"></script>
<script
	src="<?php echo JURI::root()?>modules/mod_taoyeucau/tmpl/js/jquery-ui.min.js"
	type="text/javascript"></script>
<script
	src="<?php echo JURI::root()?>modules/mod_taoyeucau/tmpl/js/jquery.multiselect.js"
	type="text/javascript"></script>
