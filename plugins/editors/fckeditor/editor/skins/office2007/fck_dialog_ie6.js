...
(function()
{
	...
	var fixSizes = window.DoResizeFixes = function()
	{
		...
		for ( var i = 0 ; i < fckDlg.childNodes.length ; i++ )
		{
			...
			{
				case 'contents' :
					//Modifed by Mark Smeed to again make it work and look like Joomla.
					child.style.width = Math.max( 0, fckDlg.offsetWidth - 26 - 29 - 14 ) ;	// -left -right
					child.style.height = Math.max( 0, fckDlg.clientHeight - 60 - 76 ) ;	// -bottom -top
					break ;
	...
	var fixCloseButton = function()
	{
		...
		/*
		Commented out By Mark Smeed on the 10th of July 2009 because Paul Franklin wanted it to look like Joomla!
