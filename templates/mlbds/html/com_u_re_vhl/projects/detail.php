<link rel="stylesheet" href="../templates/WebVHL/css/templates.css" />
...
?>
     <li>
           <span id='aj_EMPHASISPROJ' class="msts adminp">
	...
	<li>
           <span id='aj_NEW_PROJECT' class="msts adminp">
...
<!--				 </a>-->
				...
				<span id='aj_PROJECT_NAME'>	<?php  echo JText::_('TEN'); ?></span>
...
<li class="ui-state-default ui-corner-top ui-tabs-selected ui-state-active"> <!--chua tab tong quan-->
	<span onMouseDown="changeStatusTab('tab_OVERVIEW')" id="tab_OVERVIEW" class="tab_active" title="first">
		<span id='aj_OVERVIEW' class='font12'>	<?php  echo JText::_('TONG_QUAN'); ?></span>
	</span>
</li>
<li class="ui-state-default ui-corner-top"><!-- bản đồ vị trí-->
	<span onMouseDown="changeStatusTab('tab_PLANE_AREA')" id="tab_PLANE_AREA" class="tab_inactive" title="first">
		<span id='aj_PLANE_AREA' class='font12'>
...
<li class="ui-state-default ui-corner-top"><!-- Sơ đồ mặt bằng-->
	<span onMouseDown="changeStatusTab('tab_PLANE_DIAGRAM')" id="tab_PLANE_DIAGRAM" class="tab_inactive" title="first">
			<span id='aj_PLANE_DIAGRAM' class='font12'>
...
<li class="ui-state-default ui-corner-top"> <!-- Tiến độ -->
	<span onMouseDown="changeStatusTab('tab_PROGRESS')" id="tab_PROGRESS" class="tab_inactive" title="first">
		<span id='aj_PROGRESS' class='font12'>
...
<li class="ui-state-default ui-corner-top"> <!-- đối tác-->
	<span onMouseDown="changeStatusTab('tab_PARTNERS')" id="tab_PARTNERS" class="tab_inactive" title="first">
		<span id='aj_PARTNERS' class='font12'>
...
<li class="ui-state-default ui-corner-top"> <!--thanh toán-->
	<span onMouseDown="changeStatusTab('tab_PAYMENT')" id="tab_PAYMENT" class="tab_inactive" title="first">
		<span id='aj_PAYMENT' class='font12'>
...
<li class="ui-state-default ui-corner-top"><!-- liên hệ-->
	<span onMouseDown="changeStatusTab('tab_CONTACTS')" id="tab_CONTACTS" class="tab_inactive" title="first">
		<span id='aj_CONTACTS' class='font12'>
	...
	<div class="boxholder">
		<div class="box"><!-- THONG_TIN_TONG_QUAN -->
				  <!--div chua hinh anh-->
						  ...
						  <div ><!-- hình ảnh lớn--->
							...
							<div> <!--  ANH_CHINH -->
								<span id='aj_MAIN_PROPERTY_PICTURE'>
						  		...
						  		<input type="file" name="main_image" value=""  size="30"/>
							</div><!--  ANH_CHINH -->
							<?php 
							}
							?>
	...
	<?php //echo JText::_('CHI_TIET_DU_AN') ?>   
     ...
     <div class='du-an'><!-- DIA_CHI -->
           <span class="msts adminp" id='aj_ADRESS' ><?php echo JText::_('DIA_CHI') ?></span>
           <span class="bold addprj font12">
          	 <?php
				if ( $this->status == 0 )
				{
				...
				{
				?>
				<input id="address" type="text" name="address" value="<?php echo $this->row['dia_chi']  ?>" class="inputbox" size="40px" />
				<?php
				}
				?>
           </span>
    ...
    <div class='du-an'><!-- LOAI_DU_AN -->
            <span class="msts adminp"><?php echo JText::_('LOAI_DU_AN') ?>:</span>
            <span  id='aj_type_id' class="bold font12">
					<?php
					if ( $this->status == 0 )
					{
    ...
    <div class='du-an'><!--  NGAY_KHOI_CONG -->
            <span id='aj_START_DATE' class="msts adminp"><?php  echo JText::_('NGAY_KHOI_CONG')  ?> </span>
            <span class="bold font12">
            	<?php
				if ( $this->status == 0 )
				{
				...
				{
				?>
					<input type="text" class="text_area" size="40" id="start_date" name="start_date" value="<?php echo  $this->row['ngay_khoi_cong'] ?>" />
				<?php
				}
				?>
            </span>
	...
	<div class='du-an'><!-- NGAY_HOAN_THANH -->
            <span id='aj_END_DATE' class="msts adminp"><?php  echo JText::_('NGAY_HOAN_THANH')  ?></span>
            <span class="bold font12">
            <?php
			if ( $this->status == 0 )
			{
			...
			{
			?>
				<input type="text" class="text_area" size="40" id="end_date" name="end_date" value="<?php echo  $this->row['ngay_hoan_thanh'] ?>" />
			<?php
			}
			?>            
            </span>
   	...
   	<div class='du-an'><!-- NHA_DAU_TU -->
            <span class="msts adminp"><?php  echo JText::_('NHA_DAU_TU')  ?></span>
            <span class="bold font12">
          		<?php
				if ( $this->status == 0 )
				{
				...
				{
				?>
					<input id="investor" size="40" type="text" name="investor" value="<?php echo  $this->row['nha_dau_tu'] ?>" class="inputbox" size="50" />
				<?php
				}
				?>
            </span>
