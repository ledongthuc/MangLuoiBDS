 ...
 if ( $this->status == 2 ) 
		{
			...
			<div style="width:700px" >
				<center>
					...
					<span id ='ajCancael'>
						 <input type="button" onclick="submitbutton('cancel')" name="save_cancel" class="button" value="<?php echo JText::_('CENCEL') ?>" />
					</span>
				</center>
		    </div>
			<?php 
...
?>
		...
		<div class="seo_bds_admin_textarea">
				<textarea id='page_title'  name='tieu_de_trang'  class="seo_bds_admin_tieude">
				<?php echo $this->propertyData['tieu_de_trang'] ?>
				</textarea>				
		</div>
		<div class="dangtinadminbds">		
		...
		<div class="seo_bds_admin_textarea">
				<textarea id='page_keywords'  name='tu_khoa_trang'  class="seo_bds_admin_tieude">
				<?php echo $this->propertyData['tu_khoa_trang'] ?>
				</textarea>			
		</div>	
		<div class="dangtinadminbds">			
		...
		<div class="seo_bds_admin_textarea">	
			<textarea id='page_description'  name='mo_ta_trang'  class="seo_bds_admin_diengiai">
				<?php echo $this->propertyData['mo_ta_trang'] ?>
			</textarea>
		</div>
...
//							      		echo $this->usedAreaInfoString;
								  ...
								  else
								  {
								  	...
								  	<input id="living_space" type="text" name="living_space" value="<?php echo $this->propertyData['dien_tich_su_dung'] ?>" class="numberbox livinguse" size="7" onChange="getonchangevalue(this.value,'divliving_space','m<sup>2',1)"/>m<sup>2</sup>
						...
						<div class="contact_box"><!-- thong tin lien hê-->
		                                ...
		                                <div>	                           					                                
			                                <div style="float: right; width: 98%; line-height: 24px;" class="contactT">
												...
												<div class='name' >			
													<textarea  id="ghichu" name="ghichu" rows="2" cols="5" class="class_lienhe_dangtin">
														<?php echo $this->propertyData['ghi_chu_nguoi_lien_he'];  ?>
													</textarea>
												</div>	
...
<p class="space">
				 ...
				 ?>
					<script type="text/javascript" src="<?php echo JURI::root()?>plugins/editors/jce/tiny_mce/tiny_mce.js?version=150"></script>
					<script type="text/javascript" src="<?php echo JURI::root()?>plugins/editors/jce/libraries/js/editor.js?version=150"></script>
				 <?
		         }
		         ?>
    ...
    <div class="bg2 cautruc1">
		...
		/*
			...
			*/
				...
				{
					echo "<li id='divkv_width'>".$this->propertyData['dien_tich_khuon_vien_dai']."m</li>";
				}
				else
				{
			...
			{
				echo "<li id='divkv_length'>".$this->propertyData['dien_tich_khuon_vien_rong']."m</li>";
			}
			else
			{
