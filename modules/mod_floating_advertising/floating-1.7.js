...
floatingMenu.move = function (item)
{
    ...
    {
    	if ( item.id == 'left_float_div' )
    	{
    		item.nextX = document.documentElement.clientWidth/2 - 490 - 150 - 3 ;
    	}
    	else if ( item.id == 'right_float_div' )
    	{
    		item.nextX = document.documentElement.clientWidth/2 + 490 + 3;
    	}
...
floatingMenu.calculateCornerX = function(item)
{
    ...
    if ( item.id == 'left_float_div' )
	{
		result = document.documentElement.clientWidth/2 - 490 - 150;
	}
	else if ( item.id == 'right_float_div' )
	{
		result = document.documentElement.clientWidth/2 + 490;
	}
