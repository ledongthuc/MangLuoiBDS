...
class JeaControllerConfig extends JController
{
    ...
    function save()
    {
        ...
        $giatien  = JRequest::getVar('giatien'  , array() , 'POST' , 'array' );
		$idLienHe  = JRequest::getVar('idLienHe'  , array() , 'POST' , 'array' );
		$bdslienquan  = JRequest::getVar('bdslienquan'  , array() , 'POST' , 'array' );
		

        $config = array_merge( $units, $currency, $lists, $property, $pictures,$giatien,$idLienHe,$bdslienquan );
