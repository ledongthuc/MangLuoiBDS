...
define('_DML_TAB_DETAILS', "Chi tiết");
...
define('_DML_SELECTFILE', "Chọn tài liệu");
...
define('_DML_NEXT', "Tới >>>");
define('_DML_BACK', "<<< Lui");
define('_DML_LINK', "Link");
define('_DML_EDITDOC', "Edit this document");
define('_DML_UPLOADWIZARD', "Quá trình upload");
define('_DML_UPLOADMETHOD', "Chọn cách upload tài liệu");
define('_DML_ISUPLOADING', "Đang upload tài liệu, xin vui lòng chờ");
define('_DML_PLEASEWAIT', "Xin vui lòng chờ");
...
// -- Search
define('_DML_SELECCAT', "Chọn danh mục");
define('_DML_ALLCATS', "Tất cả");
define('_DML_SEARCH_WHERE', "Tìm ở");
define('_DML_SEARCH_MODE', "Tìm kiếm theo");
define('_DML_SEARCH', "Tìm kiếm");
define('_DML_SEARCH_REVRS', "Reverse");
define('_DML_SEARCH_REGEX', "Regular Expression");
define('_DML_NOT', "No"); // Used for Inversion
...
define('_DML_BUTTON_DOWNLOAD', "Tải về");
define('_DML_BUTTON_VIEW', "Xem");
define('_DML_BUTTON_DETAILS', "Thông Tin");
define('_DML_BUTTON_EDIT', "Sửa");
define('_DML_BUTTON_MOVE', "Di chuyển");
define('_DML_BUTTON_DELETE', "Xóa");
define('_DML_BUTTON_UPDATE', "Cập nhật");
define('_DML_BUTTON_CHECKOUT', "Khóa");
define('_DML_BUTTON_CHECKIN', "Mở");
define('_DML_BUTTON_UNPUBLISH', "Không hiển thị");
define('_DML_BUTTON_PUBLISH', "Hiển thị");
define('_DML_BUTTON_RESET', "Cho số lần xem về 0");
define('_DML_BUTTON_APPROVE', "Hiển thị");
