...
class UsersController extends JController
{
	...
	function save()
	{
		...
		$post['approved']	= JRequest::getVar('approved', '', 'post', 'approved');
...
function approve( )
	{
		...
		$cid 	= JRequest::getVar( 'cid', array(), '', 'array' );
		$approved  = $this->getTask() == 'approved' ? 0 : 1;	
...
function unapprove( )
	{
		...
		$cid 	= JRequest::getVar( 'cid', array(), '', 'array' );
		$approved  = $this->getTask() == 'unapprove' ? 0 : 1;
