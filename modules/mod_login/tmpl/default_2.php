...
<?php endif; ?>
<div id="login-wrap" style="margin-bottom:3px">
<form action="<?php echo JRoute::_( 'index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="login" >
	<?php echo $params->get('pretext'); ?>
			...
			<a href="<?php echo JRoute::_( 'index.php?option=com_user&view=reset&Itemid=82' ); ?>">
			<?php echo JText::_('FORGOT_YOUR_PASSWORD'); ?></a>
			<!--<a href="<?php echo JRoute::_( 'index.php?option=com_user&view=remind&Itemid=82' ); ?>">
			<?php echo JText::_('FORGOT_YOUR_USERNAME'); ?></a>-->
			<?php 
				$usersConfig = &JComponentHelper::getParams( 'com_users' );
				if ($usersConfig->get('allowUserRegistration')) : ?>
				<a href="<?php echo JRoute::_( 'index.php?option=com_user&task=register&Itemid=82' ); ?>">
