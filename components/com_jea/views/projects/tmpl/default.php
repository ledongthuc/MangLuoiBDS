...
<!--        hoan dang lam-->
      ...
      $ProjectItemid=split(",",$row->project_group_ids);
     switch ($ProjectItemid[1])
     {
		case 19 : $Pro_Item = 31;
		break;
		case 20 : $Pro_Item = 32;
      ...
      ?>
        ...
        <td height="23"><a href="index.php?option=com_jea&view=projects&Itemid=<?php echo $Pro_Item ?>&id=<?php echo $row->id?>"  > <b><?php echo $row->value?></b></a></td>
      </tr>
      <tr>
         <td valign="top"><?php echo $row->short_desc?><br /><div class="article-content">
        <a class="readon" href="index.php?option=com_jea&view=projects&Itemid=<?php echo $Pro_Item ?>&id=<?php echo $row->id?>">
