<?php
/**
 * @version		$Id: documents.html.php 1019 2009-12-08 17:16:06Z mathias $
 * @category	DOCman
 * @package		DOCman15
    ...
    function showDocuments($rows, $lists, $search, $pageNav, $number_pending, $number_unpublished, $view_type = 1)
    {
        ...
        for ($i = 0, $n = count($rows);$i < $n;$i++) {
            ...
            ?>
                ...
                <td>
                <?php if ($file->exists()) {?>
                    <a href="index.php?option=com_docman&section=documents&task=download&bid=<?php echo $row->id;?>" target="_blank">
