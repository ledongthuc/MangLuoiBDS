...
if (is_file(JPATH_SITE .DS.'modules'.DS.'mod_janews'.DS.'helper.php')) require_once (JPATH_SITE .DS.'modules'.DS.'mod_janews'.DS.'helper.php');
else require_once (JPATH_SITE .DS.'modules'.DS.'mod_janews_fp'.DS.'helper.php');
