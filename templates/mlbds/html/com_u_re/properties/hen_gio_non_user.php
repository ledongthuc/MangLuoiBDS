...
<div id="hen_gio_non_user" class="facebook" style="width:700px; height:500px; display: none;"><span class="bClose"></span>
...
<div id="subtab_2" class="box" class="box" style="display:none"> 					
						<div id="smsarea">
							<div class="smsbox">
								...
								<p class="p3">(Một tin nhắn có giá trị 5,000 VND)</p>
							</div>
							<div class="smsbox">  
