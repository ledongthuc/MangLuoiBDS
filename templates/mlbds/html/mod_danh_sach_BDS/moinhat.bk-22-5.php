...
if($data==null){
	...
	echo "<div class='clear'></div><span id='thongbao' style='position: absolute;width:632px'>Không tìm thấy bất động sản theo yêu cầu<br /><a href='".$link."'>Tạo yêu cầu BĐS, chúng tôi sẽ tự động gửi mail thông báo cho bạn</a></span>";
}else{
?>
<div class='ngaydang'>
