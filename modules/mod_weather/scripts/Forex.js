function ShowForexRate()
{
	...
	if (!AddForexHeader('Forex', 'Tỉ giá', 3, PageHost.concat(theme+'icon_stock.png')))
		return;
...
function AddForexHeader(Name, Header, Buttons, Symbol, AddChildTable)
{
	...
	document.writeln('<table width="100%" border=0 cellspacing=0 cellpadding=0><tr><td style="display:none"  id="IDM_', Name, '">');
