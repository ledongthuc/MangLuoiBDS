...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th nowrap="nowrap" width="40%" ><?php echo JText::_('Value') ?></th>
			
			<th nowrap="nowrap" width="40%" ><?php echo JText::_('Rate') ?></th>

			<th colspan="4" nowrap="nowrap"><?php echo JText::_('Ordering') ?></th>
...
<?php $altrow = ( $altrow == 1 )? 0 : 1; ?>
		...
		<tr class="row<?php echo $altrow ?>">
		    <td><?php echo $k+1 ?></td>
			<td><?php echo JHTML::_('grid.id', $k, "$row[id]@#$%^$row[ten]@#$%^$row[ti_gia]" ) ?></td>
			<td nowrap="nowrap"><a href="#edit" onclick="return listItemTask('cb<?php echo $k ?>','edit')"><?php echo $row['ten'] ?></a></td>
			<td nowrap="nowrap"><?php echo  $row['ti_gia'] ; ?></td>
