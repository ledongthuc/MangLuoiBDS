	...
	<div class="info-detail"><!-- div chua title-->
        <div class="info-structure">
	        ...
	        <?php 
	        	...
	        	{?>
        		<div class='title_details' style='float:right'>
...
?>
	 ...
	 <div class='properties-detail-img-l'>
        <div class="smoothness"> <!-- div chua tab -->
	   		<ul id="tabheader" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
				...
				<li rel="subtab2" class="ui-state-default ui-corner-top"><!-- bản đồ -->
 		...
 		<div class="boxholder" style="float:left">
			<div id="subtab1" class="box" style="float:left"> 
					  <!--div chua hinh anh-->
	...
	?>
			...
			<div class='layout-admin'>
					...
					<?php	
						...
						echo "<li class='msts admin'><input type='text' id='properties_key'  name='properties_key' value='". $this->properties_key ."' class='inputbox_id'/></li>";
	...
	<div class='layout-admin'>
		...
		<li id ='aj_types' class='admin'><?php echo $this->types; ?> </li>
	</div>
	...
	<div class='layout-admin'>
		...
		<li id ='aj_DU_AN' class='admin'>
			<?php
			if($this->propertyData['du_an_id']=='0' && $this->propertyData['du_an']!='')
			{
			?>
				<span id='duan_select'  style="float: left; display: none;width: 160px;" > 
					<?php echo $this->du_an; ?>
				</span>
			
				<span id='duan_text' style="float: left; width: 160px;" >
					<input type="text" name="du_an_text_value" id="duan_text_id" style="width: 158px; " value=" <?php echo $this->propertyData['du_an'];?>"/>
				</span>
				<input id="orderinput" checked="checked" type="checkbox" onclick="doiNhapLieu(this, 'duan_select','ten_du_an','duan_text','duan_text_id');" /> <?php  echo JText::_('KHAC'); ?>
				...
				else
			{
			 ?>
				...
				<span id='duan_text' style="float: left; display: none;width: 160px;" >
					<input type="text" name="du_an_text_value" id="duan_text_id" style="width: 158px; " value=""/>
				</span>
				<input id="orderinput" type="checkbox" onclick="doiNhapLieu(this, 'duan_select','ten_du_an','duan_text','duan_text_id');" /> <?php  echo JText::_('KHAC'); ?>
...
<?php
		...
		{
				?>
				<div class='clear'><span id='ADDRESS_' class='items-add1'><?php echo JText::_('DIA_CHI');?></span></div>
			<!-- TINH_THANH -->
			<div class='layout-admin'>
				<li class='msts admin'>
			...
			<div class='layout-admin'>
				...
				<li>
					<input  id="price" type="text" name="gia" value="<?php echo  $this->InsertPrice;//$this->propertyData['gia'] ?>" class="numberbox new2" size="5"  />
...
<?php
                                        ...
                                        else
                                        {
                                        	 ...
                                        	 echo "<div id='showRooms'><?php echo JText::_('PHONG') ?></div>";
                                        	 
                                        	 ?>
                                        	 <!--  doan code phong tam thoi  -->
 <div class='layout-admin' nowrap=\"nowrap\" class=\"label\">
 <div>
 <label for=\"mainrooms\"><li class='admin2' id='ajCLIEN_ROOM'><?php echo JText::_('PHONG_KHACH') ?></li></label>
   <li class='admin2'><select class='newroom' name ='phong_khach' onchange=getonchangevalue(this.value,'phong_khach_sl','',1)>
   <?php   
   for($i=0;$i<=9;$i++)   	
   {   $selected="" ; 
 ...
 <div>
  <label for=\"rooms\"><li class='admin2' id='ajBEDROOM'><?php echo JText::_('PHONG_NGU') ?></li></label>
   <li class='admin2'><select class='newroom' name ='phong_ngu' onchange=getonchangevalue(this.value,'phong_ngu_sl','',1) >
    <?php  
    for($i=0;$i<=9;$i++)   
    	{ 
    		$selected="" ; 
  ...
  <div class='clear'>
    <label for=\"rooms\"><li class='admin2' id='ajBATHROOM'><?php echo JText::_('PHONG_TAM') ?></li></label>
		<li class='admin2'><select class='newroom' name ='phong_tam' onchange=getonchangevalue(this.value,'phong_tam_sl','',1) >
	<?php 
	for($i=0;$i<=9;$i++) 
		{ 
			$selected="" ;
  ...
  <div>
  <label for=\"toilets\"><li class='admin2' id='ajORTHER_ROOM'><?php echo JText::_('PHONG_KHAC') ?></li></label>
  <li class='admin2'> <select class='newroom' name ='phong_khac' onchange=getonchangevalue(this.value,'phong_khac_sl','',1) >
   <?php  
   for($i=0;$i<=9;$i++)  
   	{  $selected="" ;
			        	...
			        	<div class="contact_box"><!-- thong tin lien hê-->
		                                <div>	                           					                                
											...
											?>
				                                ...
				                                <div>
				                                <span id='CONTACT_ADDRESS'  class='contact_class_label' ><?php echo JText::_('TEN_NGUOI_LIEN_HE');?></span>
												<span class="name">
										 ...
										 <div>
												...
												<span class="name">
												<?php echo $this->propertyData['dia_chi_nguoi_lien_he'] ?>                         
												</span>												
				                                </div>
							...
							<div>	                           					                                
                                ...
                                <?php
									...
									<div class="class_lienhe_dangtin">
										<input type="text" id="name_vl"  name="name_vl" class="class_lienhe_dangtin" value="<?php echo $user->name; ?>" />                               
									</div>
									<span id='CONTACT_ADDRESS'  class='contact_class_label' ><?php echo JText::_('DIA_CHI');?></span>
									<div class='name' >	
										<input type="text" id="address_vl"  name="address_vl" class="class_lienhe_dangtin" value="<?php echo $user->address; ?>"/>
									</div>
										<span id='CONTACT_PHONE'  class='contact_class_label' ><?php echo JText::_('DIEN_THOAI');?>:</span>
									<div class='name' >		
										<input type="text" name="phone_vl" class="class_lienhe_dangtin" value="<?php echo $user->phone; ?>"/>
									</div>									
									<span id='CONTACT_NOTE'  class='contact_class_label'><?php echo JText::_('GHI_CHU');?>:</span>
									<div class='name' >			
										<textarea  id="ghichu" name="ghichu" rows="2" cols="5" class="class_lienhe_dangtin"><?php if($this->propertyData['ghi_chu_nguoi_lien_he']!='')echo $this->propertyData['ghi_chu_nguoi_lien_he'];?></textarea>
									</div>	
								<?php }  
									else
									{?>
...
<div class="info-structure">
	...
	else
	{
		...
		{
			echo "<li id='phong_khach_sl'>".$this->propertyData['phong_khach']."</li>";
		}
		else
		{
			 echo "<li id='phong_khach_sl'>_</li>";
		}
...
<div class="bg2 cautruc1"><li id='ajt2_legal'><?php echo JText::_('PHAP_LY');?></li> 
 ...
 <div  class="bg1 cautruc1">
	...
	else
	{
		...
		{
			echo "<li id='phong_ngu_sl'>".$this->propertyData['phong_ngu']."</li>";
		}
		else
		{
			 echo "<li id='phong_ngu_sl'>_</li>";
		}
...
<div class="bg1 cautruc1">
	...
	else
	{
		...
		{
			echo "<li id='phong_tam_sl'>".$this->propertyData['phong_tam']."</li>";
		}
		else
		{
			echo "<li id='phong_tam_sl'>_</li>";
		}
	}
    ?> 
    </div>
	...
	else
	{
		...
		{
			echo "<li id='phong_khac_sl'>".$this->propertyData['phong_khac']."</li>";
		}
		else
		{
			echo "<li id='phong_khac_sl'>_</li>";
		}
	}
    ?>
...
<!-- map position -->
 ...
 <input id="pro_total_info" type="hidden" name="pro_total_info" value="3" />
  ...
  <style type="text/css">
            #map{width:365px;margin-top:5px;margin-left:5px;border:1px solid dashed;
                 height:320px;}
</style>
