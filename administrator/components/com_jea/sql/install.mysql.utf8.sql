...
CREATE TABLE IF NOT EXISTS `#__jea_kinds` (
  `id` int(11) NOT NULL auto_increment,
  `value` varchar(255) NOT NULL default '',
  `ordering` int(11) NOT NULL default '0',
  PRIMARY KEY  (`id`)
...
insert into #__jea_kinds(value,ordering) values('renting',0);
insert into #__jea_kinds(value,ordering) values('selling',1);
insert into #__jea_kinds(value,ordering) values('needrenting',2);
insert into #__jea_kinds(value,ordering) values('needselling',3);
-- --------------------------------------------------------
