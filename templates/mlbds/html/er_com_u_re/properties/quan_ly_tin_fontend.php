...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<strong>
		<a href="index.php"><?php echo JText::_('back home' ) ?></a>
	</strong>
	
</center>
 -->
<strong><a href="<?php echo JRoute::_('&Itemid=179&layout=form') ?>"><?php echo JText::_('Add new property' )?></a></strong>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<strong>

<form name="adminForm" id="adminForm" action="<?php echo JRoute::_('') ?>" method="post">
	<input type="text" name="search" size="27px">
	<input type="submit" name="serch_button" value="<?php echo JText::_('TIM_KIEM') ?>"> &nbsp;&nbsp;&nbsp; | &nbsp;&nbsp;&nbsp;
...
<?php foreach ($this->rows as $k => $row): $altrow = $altrow ? 0 : 1 ?>
		<tr class="row<?php echo $altrow ?>" >
			<td class="ref" width="50%">			
					<a href="<?php echo JRoute::_( 'index.php?option=com_u_re&view=manage&Itemid=179&layout=form&id='.$row['id'] ) ?>" title="<?php echo JText::_('Edit') ?>" > 
