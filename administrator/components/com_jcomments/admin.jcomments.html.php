...
?>
			...
			<th width="20%" align="left"><?php echo JText::_('A_COMMENT_OBJECT_TITLE'); ?></th>
			<th width="5%" align="left"><?php echo JHTML::_( 'grid.sort', 'A_COMPONENT', 'c.object_group', $lists['order_Dir'], $lists['order']); ?></th>
			<th width="20%" align="left"><?php echo JText::_('Tiêu đề BĐS'); ?></th>
...
?>
			<th width="5" class="title">#</th>
			<th width="5"><input type="checkbox" name="toggle" value="" onclick="checkAll(<?php echo count( $lists['rows'] );?>);" /></th>
			<th width="40%" class="title"><?php echo ($config->getInt('comment_title') > 0 ? JText::_('A_COMMENT_TITLE') : JText::_('A_COMMENT_TEXT')); ?></th>
			<th width="12" align="center">@</th>
