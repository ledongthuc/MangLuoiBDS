...
<div id="mod_project_slideshow-l">
 <div class="img-slide">
	<div class='div_project'>
			  	 	<a id ='imglink' href='#'>
			  	  		<img  width="180px" height="140px" name="hinhanh_2"> 
			  	  	</a>	  
			    </div>  
...
<h4>
	<span id="SLIDE_textBox_2" align="center" ></span>
</h4>
...
<a href="index.php?option=com_content&view=category&layout=blog&id=153&Itemid=217&lang=vi" class="xemthem"><?php echo JText::_( 'XEM_TIN_KHAC'); ?></a>
</div>
</div> 
