				...
				<li style='margin-right:0'>
					...
					<span style="float:right;margin-top: 5px">
						...
						<span id="btn_tkkv_nang_cao" class='clear check' style="display:none">
							<a href="javascript:;" onclick="showTKKVBasicSearch()" class='link'>Tìm kiếm nhanh </a>
						</span>
					</span>
				</li>
			</ul>
...
<script src="<?php echo JURI::root()?>templates/mlbds/html/mod_jea_search/js/jquery.searchabledropdown-1.0.7.src.js"></script>
...
$(function() {
	...
	$("#tab1").click(function() {
		if ( document.getElementById("tknc").style.display != "none" )
		{
	...
	$("#tab2").click(function() {
		if ( document.getElementById("tknc_kv").style.display != "none" )
		{
