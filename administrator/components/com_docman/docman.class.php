<?php
/**
 * @version		$Id: docman.class.php 1044 2009-12-12 15:25:47Z mathias $
 * @category	DOCman
 * @package		DOCman15
	...
	*/
	function loadLanguage($type)
	{
		...
		if (file_exists($this->getPath('language').'/'.$lang.'.'.$type.'.php')) {
    		require_once ($this->getPath('language').'/'.$lang.'.'.$type.'.php');
		} else {
    		require_once ($this->getPath('language').'/english.'.$type.'.php');
		}
	}
