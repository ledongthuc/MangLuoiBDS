		...
		<legend><?php echo JText::_( 'User Details' ); ?></legend>
			<table class="admintable" cellspacing="1">
				...
				<tr>
					...
					<td>
						<input class="inputbox" type="text" name="address" id="address" size="40" value="<?php echo $this->user->get('address'); ?>" />
					</td>
				</tr>
				<!-- TODO Add phone - chen them truong phone, cho phep hien thi textbox nhap so phone  -->
				<tr>
					<td class="key">
						<label for="phone">
...
<!--				hoan dang sua-->
				...
				<tr>
					...
					<td>
						<strong>
<?php echo JHTML::_('select.booleanlist',  'approved' , 'class="inputbox"' , $this->user->get('approved') ? $this->user->get('approved') : 0) ; ?>
						</strong>
					</td>
				</tr>				
				<tr>
