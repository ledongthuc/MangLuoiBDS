...
//function added by AW
function SetFCKSavedRelURL(e)
{
	FCKRegexLib.FullImgPath =  new RegExp(FCK.Config.SitePath  + "/" + FCK.Config.ImagePath,"ig");
	var sUrl = GetE('txtUrl').value.replace(FCKRegexLib.FullImgPath,FCK.Config.ImagePath) ;
	SetAttribute( e, "_fcksavedurl",sUrl) ;
