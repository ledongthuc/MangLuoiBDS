...
<div class='viewall'>
<a href='<?php echo JURI::base();?>nhadat/search/244/?searchType=map' style="text-decoration: underline;float: left;">Xem danh sách đầy đủ</a>
</div>
<?php 
...
?>
<div class='items-icon vipmoinhat <?php echo $classadd ?>'>
...
<div class='items-icon  <?php echo $classadd ?>'>
