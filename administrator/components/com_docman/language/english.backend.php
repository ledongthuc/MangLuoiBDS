<?php
/**
 * @version		$Id: english.backend.php 953 2009-10-14 20:38:38Z mathias $
 * @category	DOCman
 * @package		DOCman15
...
define('_DML_CFG_MAXFILESIZETT', "Maximum allowable filesize for Front-end uploads. You may use K/M/G as shortcuts for the entry.<br />This limit does not apply to Back-end (admin) uploads. <br /><hr />There is also a PHP config value, upload_max_filesize, which is set to ");
