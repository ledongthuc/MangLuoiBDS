...
<!--
<a  style="cursor:pointer, a.active:red" onclick="getDataLang('vi')" >
		sssssssss
	</a>
	-->
...
<?php
 ...
 <label for=\"mainrooms\"><li class='admin1' id='ajCLIEN_ROOM'><?php echo JText::_('PHONG_KHACH') ?></li></label>
   <li class='admin1'><select class='newroom' name ='phong_khach' onchange=getonchangevalue(this.value,'phong_khach_sl','',1)>
   <?php   
   for($i=0;$i<=9;$i++)   	
   {   $selected="" ; 
   ...
   <label for=\"rooms\"><li class='admin1' id='ajBEDROOM'><?php echo JText::_('PHONG_NGU') ?></li></label>
    <li class='admin1'><select class='newroom' name ='phong_ngu' onchange=getonchangevalue(this.value,'phong_ngu_sl','',1) >
    <?php  
    for($i=0;$i<=9;$i++)   
    	{ 
    		$selected="" ; 
	...
	<li class='admin1'><select class='newroom' name ='phong_tam' onchange=getonchangevalue(this.value,'phong_tam_sl','',1) >
	<?php 
	for($i=0;$i<=9;$i++) 
		{ 
			$selected="" ;
  ...
  <li class='admin1'> <select class='newroom' name ='phong_khac' onchange=getonchangevalue(this.value,'phong_khac_sl','',1) >
   <?php  
   for($i=0;$i<=9;$i++)  
   	{  $selected="" ;
