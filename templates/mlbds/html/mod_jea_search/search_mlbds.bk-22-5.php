	...
	<div style="display: block; ">
			...
			<ul>
				...
				<li id="muc_gia_nc" style="display:none"> 
					...
					<span class='clear'>
						...
						<div style='float: left;padding: 0;height: 20px;width: 96px;font-size: 12px;line-height: 17px;margin-top: -6px;'>
				...
				<li style='  margin-right: 0;margin-top: 20px;width: 96px;'>
				...
				<li class='but-search' id="tim_kiem_co_ban">
					<span style='float:right' >
						<input type="button" value="Tìm trên danh sách" class='btn-search-ds' onclick="submitSearchForm('dk')">
						<span class='clear check'>
						<input type="button" value="Tìm trên bản đồ" class='btn-search-bd' onclick="submitSearchForm('map')">
						<span class='clear check'>
		...
		<div id="tknc" style=''>
			...
			<li id="phong_tam_nc">
					...
					<span class="clear">
						<input id="phong_tam_tu" name="phong_tam_tu" type="text" style="width: 99px;" class="input-s2" 
							value="<?php if ( !empty( $_GET['phong_tam_tu'] ) ) {
								echo $_GET['phong_tam_tu']; 
							} else { echo 'Từ'; }
							?>"
							onclick="clearDefaultValue( this, 'Từ' )" onblur="setDefaultValue( this, 'Từ' )"> 
						<input id="phong_tam_den" name="phong_tam_den" type="text" style="width: 99px;margin-right:28px;" class="input-s2" 
			...
			<li class='but-search' style="margin-top:-6px" id="tim_kiem_nang_cao">
					<span style='float:right' >
						<input type="button" value="Tìm trên danh sách" class='btn-search-ds' onclick="submitSearchForm('dk_nang_cao')">
						<span class='clear check'>
						<input type="button" value="Tìm trên bản đồ" class='btn-search-bd' onclick="submitSearchForm('map_nang_cao')">
						<span class='clear check'>
