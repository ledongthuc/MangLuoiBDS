<?php 
	...
	$arrtext = explode  ('##',$getsesvalue['value']);
	$arrimg = explode  ('##',$getsesimg);
	$imglink = explode  ('##',$getsesvalue['link']);
	$newvalue = explode  ('##',$getnew['title']);
?>
<script language="javascript" type="text/javascript">
	var SLIDE_text = ['<?php echo join('\',\'', $arrtext); ?>'];
...
<div style="float:left; width:50%;">
 <a id ='imglink' href='#'>
            ...
            <p><span id="SLIDE_textBox" align="center" ></span></p>
</div>
...
<div style="float:right; width:50%" id="SLIDE_textBox">
<?php echo join($arrtext); ?>
<!--<p id="spagens" style="text-align:left; float:right;position:absolute; height:40px;clip:rect(10px 441px 47px 0px);"></p>-->
</div>
<div class="clear">
</div>
	<script language="javascript" type="text/javascript" >
