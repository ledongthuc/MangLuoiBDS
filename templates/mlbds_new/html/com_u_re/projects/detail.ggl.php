<link rel="stylesheet" href="../templates/webhg/css/templates.css" />
...
<div id="content" style='float:left; width:100%'><!-- CONTENT -->
	<div class="smoothness"> <!-- div chua tab-->
		<ul id="tabheader" class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
			...
			<li rel="subtab3" class="ui-state-default ui-corner-top"><!-- tien do-->
				<span class="tab_inactive">
					<a><?php  echo JText::_('TIEN_DO'); ?></a>
				</span>		
			</li><!-- tiến độ -->
		...
		<?php /* bo muc tin tuc	<li rel="subtab5" class="ui-state-default ui-corner-top"> <!-- tin tức liên quan -->
				<span class="tab_inactive">
...
?>
		...
		<div id="subtab2" class="box" style="display:none"><!-- TIEN_ICH -->
			<?php
			// so do mat bang
			if ( $this->status == 0 )
			{
			...
			else
			{
				...
				echo $editor->display( 'tienich',  $this->row['tien_ich'] , '100%', '400', '75', '20', false ) ;
			}
			?>
		</div><!-- TIEN ICH DU AN -->
		
		<div id="subtab3" class="box" style="display:none"><!-- SO_DO_MAT_BANG -->
			<?php
			// so do mat bang
			if ( $this->status == 0 )
			{
