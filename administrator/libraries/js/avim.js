...
function AVIM()	{
	...
	if(AVIMGlobalConfig.showControl) {
		...
		document.write('<div id="AVIMControl">');
		document.write('Bộ gõ Tiếng việt');
		document.write('<span class="AVIMControl"><input id="avim_auto" type="radio" name="AVIMMethod" onClick="AVIMObj.setMethod(0);" />Tự động');
		...
		document.write('<input type="checkbox" id="avim_daucu" onclick="AVIMObj.setDauCu(this);" />Kiểu cũ</span>');
		document.write('</div>');
	}
