...
<div id="checkout2"> 
	<div class="area" id="usertb" >
		<table>
			...
			<tr>	
				<td>Quyền đẩy tin</td> 
				<td><input onkeypress="return limit(event)" value="0" type="text" id="quyen_daytin"  onkeyup="recount(1,this.value);"/></td>
				<td><div id="gia_1"></div></td>
				<td><div id="sum_1"></div></td>
			</tr>
			<tr>
				<td>Quyền đánh dấu</td>
				<td><input onkeypress="return limit(event)" value="0" type="text" id="quyen_danhdau" onkeyup="recount(2,this.value);"/></td>
				<td><div id="gia_2"></div></td>  
				<td><div id="sum_2"></div></td>    
			</tr>
			<tr>
				<td>Quyền nổi bật</td>
				<td><input onkeypress="return limit(event)" value="0" type="text" id="quyen_noibat" onkeyup="recount(3,this.value);"/></td>
	...
	function ck(typex,soluong){		
		$.ajax({
			...
			var tmp=data.split("|"); 
				...
				var dongia=tmp[1];
				var sumrow=soluong*dongia;
				sumrow-=(sumrow*tmp[0]/100);
				(typex==1)?sumrow1=sumrow:(typex==2)?sumrow2=sumrow:sumrow3=sumrow;
				document.getElementById('sum_'+typex).innerHTML=fmoney(sumrow);
