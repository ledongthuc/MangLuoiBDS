	...
	<div class="info-detail"><!-- div chua title-->
        <div class="info-structure">
			...
			<table border="0" style="width:450px; margin-left:-3px;">
				...
				<?php 
				$userid = $user->get('id');
				if($this->propertyData['ma_nguoi_dang']==$userid){?>
				<tr> 
...
?>
	...
	<?php if($this->status==0){?>
			...
			<div class='clas2'>
				<ul>
					<li class='back' onclick=<?php if(isset($_SERVER['HTTP_REFERER'])) echo 'window.location="'.$_SERVER['HTTP_REFERER'].'"'; else echo 'window.location="'.JURI::base().'"' ?>>
					Quay lại
					</li>
