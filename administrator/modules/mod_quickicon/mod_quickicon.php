...
if (!defined( '_JOS_QUICKICON_MODULE' ))
{
	...
	<div id="cpanel">
		...
		if ( $user->get('gid') < 26 ) {
		$link = 'index.php?option=com_jea&controller=properties&cat=selling';
		quickiconButton( $link, 'icon-48-archive.png', JText::_( 'PROPERTIES' ) );
		
		$link = 'index.php?option=com_jea&controller=properties&cat=selling&task=add';
		quickiconButton( $link, 'icon-48-generic.png', JText::_( 'ADD PROPERTIES' ) );
		
		$link = 'index.php?option=com_jea&controller=realtors';
		quickiconButton( $link, 'icon-48-section.png', JText::_( 'REALTORS' ) );
		
		$link = 'index.php?option=com_jea&controller=realtors&task=add';
		quickiconButton( $link, 'icon-48-module.png', JText::_( 'ADD REALTORS' ) );
		...
		quickiconButton( $link, 'icon-48-menu.png', JText::_( 'ADD NEW ARTICLE' ) );
/*
...
*/
		...
		quickiconButton( $link, 'icon-48-user.png', JText::_( 'Add User' ) );
