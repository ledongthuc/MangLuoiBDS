		...
		<table cellpadding="0" cellspacing="0" border="0" width="100%" style="height: 100%">
					...
					<table width="80" height="60" border="0" align="right" cellpadding="2" cellspacing="0" bgcolor="#ffffff">
						<tr>
						  <td align="center" nowrap="nowrap" bgcolor="#CCCCCC" style="border-right: #000000 1px solid; border-top: #000000 1px solid;
								border-left: #000000 1px solid; border-bottom: #000000 1px solid"><p><span class="style3" fcklang="DlgAboutVersion">Version </span><span class="style1"><br>
						  <b>2.6.4.1</b></span><b><br>
						  <br>
						  </b></p>
						  </td>
						</tr>
			...
			<tr>
			  <td width="86%" nowrap="nowrap">
					<p><span fcklang="DlgAboutInfo">For further information and support please visit - </span>&nbsp;<a href="http://www.joomlafckeditor.com"  target="_blank">www.joomlafckeditor.com</a><br />
					  Copyright <a href="http://www.webxsolution.com/" target="_blank">WebxSolution Ltd</a> &copy; 2005-2009<a href="http://www.joomlafckeditor.com/joomla-license" target="_blank"><br>
...
<?php 
	$version = (defined('_VALID_MOS') ? new joomlaVersion() : new JVersion());
