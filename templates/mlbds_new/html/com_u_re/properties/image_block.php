...
if ( (!empty( $this->data ) && is_array( $this->data )) || $status != 0 )
{
	...
	?>
	<a id='' rel='prettybox[image_bds]' onclick="return false" href='<?php echo $mainImage['max_url'] ?>' title='<?php echo $slideshowTitle?>' >
	...
	{
	?>
	<a rel='prettybox[image_bds]' onclick="return false" href='<?php echo JURI::root()?>images/noimage.jpg'  >
...
<script type="text/javascript" charset="utf-8">
	...
	{
		$("a[rel^='prettybox']:eq(0)").trigger('click.prettyphoto');
		//return false;
	 }	
</script>
<div class="clear"> </div>
