...
<body onload="javascript:setFocus()">
	<div id="border-top" class="<?php echo $this->params->get('headerColor','green');?>">
		<div>
			<div>
				<span class="title"><?php echo $this->params->get('showSiteName') ? $mainframe->getCfg( 'sitename' ).' - Quản Trị Hệ Thống' : JText::_('Administration'); ?></span>
			</div>
		</div>
	</div>
	<div id="content-box">
...
<div id="footer">
	<p class="copyright">
		<a href="http://www.joomla.org" target="_blank"></a>
